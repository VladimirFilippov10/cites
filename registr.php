    ...
    <main class="container mx-auto p-12">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md mx-auto">
            ...
            <form>
                ...
                <div class="mb-6">
                    <button type="submit" class="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Зарегистрироваться</button>
                </div>
            </form>
        </div>
    </main>
