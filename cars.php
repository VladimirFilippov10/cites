    ...
    <main class="flex-grow">
        ...
        <div class="bg-gray-100 p-6 rounded-lg shadow-md w-full max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <select id="brand" class="border border-gray-300 rounded-lg p-2" onchange="loadModels()">
                ...
                <select id="model" class="border border-gray-300 rounded-lg p-2">
                ...
                <div class="flex space-x-2">
                    <select id="year" class="border border-gray-300 rounded-lg p-2">
            ...
            <div class="flex flex-col w-full p-5 space-y-5">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<img alt="' . $row['cars_win'] . '" class="h-full w-full object-cover" src="' . $row['image_path'] . '" />';
                        echo '</div>';
                        ...
                        echo '<p class="text-gray-600 text-sm">' . ($row['body_type'] ?? 'Неизвестно') . '</p>';
                        echo '<div class="flex items-center mt-2">';
                        echo '<span class="text-green-600 text-lg font-bold">' . ($row['price'] ?? 'Неизвестно') . ' ₽</span>';
                        echo '</div>';
                        echo '<div class="flex items-center mt-2">';
