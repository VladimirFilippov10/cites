...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT cars_in_price FROM cars WHERE cars_id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $new_price_status = !$car['cars_in_price']; // Toggle the boolean value

        // Обновление значения cars_in_price
        $updateQuery = "UPDATE cars SET cars_in_price = ? WHERE cars_id = ?";
